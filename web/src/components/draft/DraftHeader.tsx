// web/src/components/draft/DraftHeader.tsx
    ...
    <div className="w-full max-w-lg flex flex-col gap-3 mb-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-300 text-xs font-semibold truncate max-w-[130px] flex items-center gap-1">
      ...
      <div className="bg-slate-900/90 backdrop-blur-md p-2.5 rounded-xl border border-slate-800 flex flex-col gap-1.5 shadow-md">
        <div className="flex justify-between items-center text-xs font-semibold">
          <span className="text-slate-400">🎯 Objetivo para Avanzar:</span>
